...
export const Mat = {
    ...
    transform: function <C extends number, R extends number>(mat: Mat<C, R>, vec: Vec<C>): Vec<C> {
        let ret = [];
    ...
    transpose: function <C extends number, R extends number>(mat: Mat<C, R>): Mat<R, C> {
    ...
    mult: function <C extends number, R extends number, C2 extends number>(a: Mat<C, R>, b: Mat<C2, C>): Mat<C2, R> {
        const A = a as [number[]];
        const B = b as [number[]];
